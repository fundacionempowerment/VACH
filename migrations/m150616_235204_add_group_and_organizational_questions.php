...
class m150616_235204_add_group_and_organizational_questions extends Migration {
    ...
    public $groupQuestions = [
        // INICIATIVA
        ['¿Es proactivo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Ve las oportunidades de mejora?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con la mejora continua?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la Iniciativa?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //PERTINENCIA
        ['¿Se considera idóneo en su trabajo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Habla con fundamentos?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Considera que sus intervenciones aportan al Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la Pertinencia?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //PERTENENCIA
        ['¿Es consciente de que necesita de su Equipo para crecer?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Está satisfecho con la trayectoria de la Empresa?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está satisfecho con la trayectoria de los integrantes del Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Cuida los vínculos?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Toma su lugar en el Equipo?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Está comprometid@ con la Pertenencia?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //TRABAJO EN EQUIPO
        ...
        ['¿Considera que es importante su feedback al Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Considera que es importante el feedback que recibe de su Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con el Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //FLEXIBILIDAD
        ...
        ['¿Está comprometid@ con la Flexibilidad?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //COMUNICACIÓN
        ['¿Escucha profundamente?', self::ANSWER_NONE_TO_ALL],
        ['¿Chequea que su mensaje sea comprendido?', self::ANSWER_ALL_TO_NONE],
        ['¿Mantiene una comunicación regular con sus pares?', self::ANSWER_ALL_TO_NONE],
        ['¿Es consciente que la información que gestiona llegue en tiempo y forma a destino?', self::ANSWER_ALL_TO_NONE],
        ['¿Maneja alguna estrategia de control sobre la información que administra?', self::ANSWER_ALWAYS_TO_NEVER],
        ['¿Tiene en cuenta el contexto al momento del diálogo?', self::ANSWER_ALWAYS_TO_NEVER],
        ...
        ['¿Cree que le da lo suficiente a su Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Le preocupa el desarrollo de su Gente?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Está comprometid@ con el Liderazgo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //LEGITIMACIÓN
        ['¿Está tranquilo cuando otros lo representan?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Se fía de lo que sus pares y subordinados le cuentan?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Cree que la valoración del otro (hacia usted) es importante?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Considera importante su presencia en el Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Confían en Usted?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Reconoce las potencialidades de los demás?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Dice y actúa según lo que piensa?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Está comprometid@ con la Legitimación?', self::ANSWER_NONE_TO_ABSOLUTLY],
    ];
    public $organizationalQuestions = [
        // CREATIVIDAD
        ['¿Adhiere a la creatividad por convicción?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Reconoce esta competencia como una exigencia propia del contexto del mercado?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Se considera una persona creativa?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la creatividad?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //ORIENTACIÓN A LOS RESULTADOS
        ['¿Es productiv@ en sus tareas?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Reconoce la importancia de hacer seguimiento y medición del avance de los resultados?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con la orientación a los resultados?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Conoce la totalidad de los productos y servicios de la Org.?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Presenta propuestas y soluciones que agregan valor a sus clientes?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Tiene la capacidad de empatizar con sus clientes?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la atención al cliente?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //ORIENTACIÓN A LA CALIDAD
        ['¿Cuida el detalle al momento de presentar los trabajos?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Se reconoce eficiente al momento de afectar los recursos para su labor?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la calidad?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //GESTIÓN DEL CAMBIO
        ['¿Adhiere a la gestión del cambio por convicción?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Entiende el cambio como una dinámica propia del Negocio?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿L@ consideran una persona flexible a los cambios?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Considera que el cambio es mejora?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Tiene la capacidad de comprender y apreciar perspectivas diferentes?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Hace una revisión crítica de las estrategias y objetivos de su Área?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Alienta y valoriza los cambios?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con la gestión del cambio?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //RESOLUCIÓN DE CONFLICTOS
        ['¿Sabe abordar y resolver conflictos?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ...
        ['¿Está comprometid@ con la resolución de conflictos?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //VISIÓN ESTRATÉGICA
        ['¿Proyecta en su tarea diaria escenarios futuros?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Reconoce esta competencia como una exigencia propia del contexto del mercado?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Se considera una persona que trabaja “mirando más allá”?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Considera que sus compañeros l@ ven como una persona con visión a futuro?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Alienta y valoriza el análisis estratégico de la gestión que hace su Equipo?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Cree que le da lo suficiente a su Equipo?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está de acuerdo con que la visión estratégica permite adelantarse al futuro y optimizar decisiones?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con la visión estratégica de la Org.?', self::ANSWER_NONE_TO_ABSOLUTLY],
        //IDENTIDAD
        ...
        ['¿Se ajustan sus acciones a las necesidades de la Org.?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Sabe lo que se esperan de Ud. en su trabajo?', self::ANSWER_NEVER_TO_ALWAYS],
        ['¿Considera que su aporte es importante para la Misión de la Org.?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Reconoce los canales regulares de toma de decisiones?', self::ANSWER_NONE_TO_ABSOLUTLY],
        ['¿Está comprometid@ con la identidad?', self::ANSWER_NONE_TO_ABSOLUTLY],
    ];
